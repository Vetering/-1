    ...
    <el-container>
      ...
      <el-aside :width="asideWidth" style="min-height: 100vh; background-color: #001529">
        <div style="height: 60px; color: white; display: flex; align-items: center; justify-content: center">
          ...
          <span style="font-size: 15px; margin-left: 10px" class="logo-title" v-show="!isCollapse">后台信息管理系统</span>
        </div>
        ...
        <el-menu :default-openeds="['info']" :collapse="isCollapse" :collapse-transition="false" router background-color="#001529" text-color="rgba(255, 255, 255, 0.65)"
          ...
          <el-submenu index="info" >
            ...
            <el-menu-item index="/user" v-if="user.role === 'root'  || user.role === 'marketer'">用户信息</el-menu-item>
            <el-menu-item index="/news">新闻信息</el-menu-item>
            <el-menu-item index="/notice" v-if="user.role === 'root'">系统公告</el-menu-item>
            <el-menu-item index="/logs" v-if="user.role === 'root'">系统日志</el-menu-item>
            <el-menu-item index="/charts" v-if="user.role === 'root' || user.role === 'marketer'">数据统计</el-menu-item>
...
export default {
  ...
  methods: {
    ...
    logout() {
      localStorage.removeItem('StudentSystem-user')  // 清除当前的token和用户数据
      this.$router.push('/login')
    },
    handleFull() {
